    ...
    <div class="static terms">
        <div class="inner">
            ...
            <p>
                ...
                <span>4.17.</span> {{__('При пользовании услугами Сервиса FishGun.ru, Пользователь подтверждает, что законно владеет и распоряжается денежными средствами и электронной валютой, участвующими в соответствующем Платеже.')}}<br>
