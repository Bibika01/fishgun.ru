                ...
                <div class="successTransaction_wrap__3GnCs"
                    ...
                    <article>
                        @if($application->status == "OK")
                            <h1 class="successTransaction_title__2AmtN">Your transaction is completed!</h1>
                            <p class="successTransaction_text__2sAEC">Wow! That was quick</p>
                        @endif
                            @if($application->status == "REJECTED")
                                <h1 class="successTransaction_title__2AmtN" style="color: #e03e2d;">Something went wrong</h1>
                        ...
                        <div class="successTransaction_buttonWrap__j-k1F">
                            <button type="button" onclick="window.location.href = '{{ route('exchange') }}';" value="" name="" style="background-color: #f1c40f; color: #c46632; border: none; font-weight: bolder; padding: 30px 20px; border-radius: 20px; font-size: 18px; cursor: pointer;"
                                    class="sample-5b6a034462329130-module_cls2__ZOxC8 sample-5b6a034462329130-module_cls1__501DX sample-5b6a034462329130-module_isRadius__w-Es2 sample-5b6a034462329130-module_size-large__XeKQs sample-5b6a034462329130-module_color-yellow__l7O7U">
                                AGAIN
                            </button>
                        </div>
                    </article>
